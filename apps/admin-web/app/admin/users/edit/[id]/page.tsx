    ...
    return (
      <main className="space-y-6">
        <div className="text-center py-12">
          <h1 className="text-2xl font-semibold text-[color:var(--text)]">User Not Found</h1>
          <p className="text-[color:var(--text-muted)] mt-2">The user you're looking for doesn't exist.</p>
          <button
