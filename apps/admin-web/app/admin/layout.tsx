...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Development mode bypass - auto-authenticate if no auth is set
  React.useEffect(() => {
    if (!isAuthenticated && typeof window !== 'undefined') {
      const isDev = process.env.NODE_ENV === 'development';
      if (isDev && !localStorage.getItem('isAuthenticated')) {
        ...
        <nav className="grid gap-1 p-2">
          ...
          <div className="mt-2">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/contexts">
              ...
              {!sidebarCollapsed && <span>Contexts</span>}
            </Link>
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/contexts/import-places">
              ...
              {!sidebarCollapsed && <span>Import Places</span>}
            </Link>
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/intent">
              ...
              {!sidebarCollapsed && <span>Intent System</span>}
            </Link>
          </div>
          ...
          <div className="mt-3">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/sessions">
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8h2a2 2 0 012 2v7a5 5 0 00-10 0v1m10 0H7" /></svg>
              {!sidebarCollapsed && <span>Session</span>}
            </Link>
          </div>
          ...
          <div className="mt-3">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/agents">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/agents-master">
              ...
              {!sidebarCollapsed && <span>Agents Master</span>}
            </Link>
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/agents-test">
              ...
              {!sidebarCollapsed && <span>Agents Test</span>}
            </Link>
          </div>
          ...
          <div className="mt-3">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/requests">
              ...
              {!sidebarCollapsed && <span>RAG Requests</span>}
            </Link>
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/api">
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7h16M3 12h16M3 17h16" /></svg>
              {!sidebarCollapsed && <span>API Docs & Test</span>}
            </Link>
          </div>
          ...
          <div className="mt-3">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/ai-costs">
              ...
              {!sidebarCollapsed && <span>AI Cost Summary</span>}
            </Link>
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/ai-usage">
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V4m0 12v4" /></svg>
              {!sidebarCollapsed && <span>AI Usage</span>}
            </Link>
          ...
          <div className="mt-3">
            ...
            <Link prefetch={false} className={`no-underline text-[color:var(--text)] hover:bg-[color:var(--bg-muted)] rounded-md flex items-center ${sidebarCollapsed ? 'justify-center px-0 py-2' : 'px-3 py-2 gap-3'}`} href="/admin/ai-pricing">
              <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h8M8 11h8M8 15h5" /></svg>
              {!sidebarCollapsed && <span>AI Pricing</span>}
            </Link>
