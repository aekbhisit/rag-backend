...
export interface UniversalMessage {
  ...
  metadata: {
    ...
    channel: 'realtime' | 'normal' | 'human' | 'line';
    language?: string;
...
export interface ConversationContext {
  ...
  activeChannel: 'realtime' | 'normal' | 'human' | 'line';
...
export interface ChannelConfig {
  type: 'realtime' | 'normal' | 'human' | 'line';
  isActive: boolean;
  capabilities: ('voice' | 'text' | 'function_calls' | 'human_handoff')[];
  fallbackChannel?: 'realtime' | 'normal' | 'human' | 'line';
  priority: number;
}
...
export interface RoutingDecision {
  ...
  reason: string;
  confidence: number;
  fallback?: 'realtime' | 'normal' | 'human' | 'line';
  metadata?: Record<string, any>;
}

export interface UserPreferences {
  preferredChannel: 'realtime' | 'normal' | 'human' | 'line' | 'auto';
