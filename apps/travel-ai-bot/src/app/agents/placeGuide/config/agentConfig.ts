...
const placeGuide: AgentConfig = {
  name: "placeGuide",
  publicDescription: "Specialized agent for place information, recommendations, and location-based searches",
  instructions: `
...
`,
  ...
  transferSettings: {
    canTransfer: true,
    transferMessage: "I'll help you find great places and attractions. Let me search for the best recommendations for you!",
  },
};
