...
// Create the transfer back handler for front desk authentication agent
const handleTransferBack = createTransferBackHandler('authenticationAgent');

/**
 * Front desk authentication agent
 * Handles caller verification and authentication processes
 */
...
`,
  ...
  // Add toolLogic with transferBack handler
  toolLogic: {
