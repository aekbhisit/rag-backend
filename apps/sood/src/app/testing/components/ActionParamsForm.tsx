      ...
      {paramDefinitions.map((param) => (
        <div key={param.name} className="flex flex-col">
          ...
          {param.type === 'boolean' ? (
            ...
            <textarea
              className="p-2 border border-gray-300 rounded h-24 font-mono text-sm text-gray-900 placeholder-gray-500"
            ...
            <input
              className="p-2 border border-gray-300 rounded text-gray-900 placeholder-gray-500"
