      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-12 sm:mb-16">
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-200">
            ...
            <h3 className="text-base sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Smart Destination Discovery</h3>
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-200">
            ...
            <h3 className="text-base sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Itinerary Planning</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-200">
            ...
            <h3 className="text-base sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">24/7 Travel Support</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg border border-gray-200">
            ...
            <h3 className="text-base sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">Real-time Updates</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link 
              href="/main" 
              className="group relative px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 flex items-center gap-2 sm:gap-3"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <span className="text-sm sm:text-base">Main Application</span>
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 rounded-lg transition-opacity duration-200"></div>
            </Link>
            
            <Link 
              href="/chat" 
              className="px-6 py-3 sm:px-8 sm:py-4 bg-white text-gray-700 font-semibold rounded-lg shadow-md hover:shadow-lg border-2 border-gray-200 hover:border-gray-300 transform hover:-translate-y-1 transition-all duration-200 flex items-center gap-2 sm:gap-3"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
              <span className="text-sm sm:text-base">Chat Base</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm sm:text-base">Travel Bot</span>
            </Link>
            ...
            >
              ...
              <span className="text-sm sm:text-base">Test App</span>
            </Link>
          </div>
          
          <p className="text-gray-500 mt-5 sm:mt-6 text-xs sm:text-sm">
        ...
        <div className="mt-16 sm:mt-20 text-center">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 text-gray-400 text-xs sm:text-sm">
            <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span>Powered by OpenAI Realtime API & Advanced Travel Intelligence</span>
          </div>
        </div>
      </div>
    </main>
