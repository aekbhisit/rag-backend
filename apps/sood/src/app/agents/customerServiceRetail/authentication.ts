...
import { 
  authenticate_user_information, 
  save_or_update_address, 
  update_user_offer_response 
} from "./toolImplementations/authenticationTools";
import { createTransferBackHandler } from "../core/functions";

// Create the transfer back handler for authentication agent
