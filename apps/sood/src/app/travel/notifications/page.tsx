          ...
          <div className="px-6 py-2 border-b border-stone-200 bg-white">
            <nav className="ta-breadcrumb" aria-label="Breadcrumb">
              <ol className="flex items-center gap-2">
                ...
                <li>
                  <span className="inline-flex items-center px-3 py-1.5 rounded-md bg-emerald-600 text-white">{currentLanguage==='th'?'การแจ้งเตือน':'Notifications'}</span>
                </li>
              </ol>
            </nav>
          </div>
          ...
          <div className="flex-1 min-h-0 overflow-y-auto p-6 space-y-4">
            <div className="border border-stone-200 rounded-lg p-4 bg-white">
              ...
              <div className="mt-2 flex items-center gap-2">
                <button onClick={requestPermission} className="px-3 py-2 rounded bg-emerald-600 text-white hover:bg-emerald-700" disabled={permission==='granted' || permission==='unsupported'}>
